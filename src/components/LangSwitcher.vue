  ...
  <div class="flex flex-row items-center">
    <button
      ...
      :class="{
        ...
        'bg-app-green/20': selectedLanguage !== 'en',
      }"
    ...
    >
      ...
      <img src="../assets/icons/en.png" class="w-4 h-4 ml-1" />
    </button>
    ...
    <button
      ...
      :class="{
        ...
        'bg-app-green/20': selectedLanguage !== 'fr',
      }"
    ...
    >
      ...
      <img src="../assets/icons/fr.png" class="w-4 h-4 ml-1" />
    </button>
  </div>
</template>
