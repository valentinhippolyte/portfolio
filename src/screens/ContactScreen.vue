<template>
  <section id="about" class="bg-app-second-bg">
    ...
    <div
      class="flex flex-col gap-16 lg:flex-row lg:justify-around pt-8 sm:pt-16 md:pt-26 lg:pt-40"
    >
      <div
      ...
      >
        ...
        >
          <div class="flex flex-col items-center gap-4 mb-10">
            <!-- Icon -->
            <div
              class="size-16 rounded-full overflow-hidden flex items-center bg-white p-2 hover:cursor-pointer"
            >
              <svg
      ...
      >
        <!-- Address part -->
        <div
          class="flex flex-col items-center gap-4 mb-10 w-full sm:w-1/2 lg:w-1/2"
        >
          <!-- Icon -->
          <div
            class="size-16 rounded-full overflow-hidden flex items-center bg-white p-2"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="90"
        ...
        >
          ...
          <div class="flex gap-5">
            <!-- Icon -->
            <div
              class="size-12 rounded-full overflow-hidden flex items-center bg-white p-2"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="90"
